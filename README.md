...
5. ครูสามารถลงทะเบียนบัญชีจากหน้า Login ได้ จากนั้น admin ต้องเข้าเมนู `จัดการผู้ใช้` แล้วเปลี่ยนสถานะเป็น `อนุมัติ/ใช้งาน`
6. สร้างบัญชีผู้ใช้งานจริง และไม่แชร์บัญชี admin ให้ผู้ใช้ทั่วไป
...
- `ครู`: บันทึกไปราชการ/ลากิจของตนเอง ดำเนินการแลกคาบ และอนุมัติรายการที่ตนเองเป็นครูปลายทาง
